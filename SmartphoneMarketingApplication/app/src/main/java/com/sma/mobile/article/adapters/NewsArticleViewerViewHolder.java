...
public class NewsArticleViewerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    @BindView(R.id.text_view_publish_date)
    public TextView textViewPublishData;

    public NewsArticleViewerViewHolder(View itemView,
