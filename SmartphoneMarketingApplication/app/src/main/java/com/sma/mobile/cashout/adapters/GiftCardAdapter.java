...
public class GiftCardAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<GiftCodeResponse> itemList;
     ...
     * @param itemList
     */
    public GiftCardAdapter(Context context, List<GiftCodeResponse> itemList,
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof PhoneCardViewHolder) {
            ...
            final GiftCodeResponse phoneCardResponse = itemList.get(position);
