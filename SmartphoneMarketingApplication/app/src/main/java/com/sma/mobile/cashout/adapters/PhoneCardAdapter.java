...
public class PhoneCardAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<PhoneCardResponse> itemList;
     ...
     * @param itemList
     */
    public PhoneCardAdapter(Context context, List<PhoneCardResponse> itemList,
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof PhoneCardViewHolder) {
            ...
            final PhoneCardResponse phoneCardResponse = itemList.get(position);
