...
public class FloatingWidgetService extends Service implements View.OnClickListener {
    ...
    private View mFloatingWidgetView, expandedView;
    private ImageView remove_image_view;
    private Point szWindow = new Point();
    private View removeFloatingWidgetView;

    private AutoScrollViewPager viewPager;
    private NewsArticleViewerPagerAdapter newsArticleViewerPagerAdapter;
    ...
    private int positionPageSelected;
     ...
     * @param context
     */
    private void redirectArticlesActivity(Context context, String articleId) {
        ...
        bundle.putString("NEWS_ID", articleId);
        bundle.putInt("KEY_NAME_RESULT", 1);
    ...
    public String getDeviceSerialNumber() {
        ...
        String deviceSerialNumber = pref.getString("DEVICE_SERIAL", "ERROR");
    ...
    private void addFloatingWidgetView(LayoutInflater inflater) {
        ...
        viewPager = (AutoScrollViewPager) mFloatingWidgetView.findViewById(R.id.view_pager);
        ...
        FintechvietSdk.getInstance().getArticlesResponse(getDeviceSerialNumber(), 1, "", new JCallback<ArticlesResponse>() {
            @Override
            public void onResponse(Call<ArticlesResponse> call, Response<ArticlesResponse> response) {
                if (response.code() == 200) {
                    ...
                    newsArticleViewerPagerAdapter = new NewsArticleViewerPagerAdapter(getApplicationContext(), listArticlesResponse).setInfiniteLoop(true);
                    viewPager.setAdapter(newsArticleViewerPagerAdapter);
                    viewPager.setInterval(2000);
                    viewPager.startAutoScroll();
                    viewPager.setStopScrollWhenTouch(true);
                } else {
                    Intent discoveryIntent = new Intent(getApplicationContext(), FloatingWidgetService.class);
...
//                PixelFormat.TRANSLUCENT);
    ...
    private void implementTouchListenerToFloatingWidgetView() {
        ...
        View viewOnClickListener = mFloatingWidgetView.findViewById(R.id.on_click_listener_id);
        viewOnClickListener.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //positionPageSelected
                ArticlesItem articlesItem = listArticlesResponse.get(positionPageSelected);
                if (null != articlesItem) {
                    redirectArticlesActivity(getApplicationContext(), articlesItem.getArticleId());
                }
                System.exit(0);
            }
        });
        viewOnClickListener.setOnTouchListener(new View.OnTouchListener() {
