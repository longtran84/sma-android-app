...
//        TextView textView = (TextView) tabView.findViewById(R.id.tab_title_id);
//        if (textView != null) {
...
//            TextView tab_title = (TextView) v.findViewById(R.id.tab_title_id);
//            tab_title.setBackgroundColor(0x00000000);
//            tab_title.setTextColor(0xFF000000);
//            if (tab_title != null) {
...
//            mRectPaint.setColor(MaterialColorPalette.getRandomColor(positionColor));
...
//        //amRectPaint.setColor(mIndicatorColor);
//        //mRectPaint.setColor(MaterialColorPalette.getRandomColor(positionColor));
//        Pair<Float, Float> lines = getIndicatorCoordinates();
...
//        mRectPaint.setAntiAlias(true);
//        //mRectPaint.setColor(0xf0000000);
//        //mRectPaint.setStyle(Paint.Style.STROKE);
//        mRectPaint.setAntiAlias(true);
//
//
//        mRectPaint.setStyle(Paint.Style.FILL_AND_STROKE);
//        mRectPaint.setColor(0xFFffcb2f);
//
//        RectF rect = new RectF(lines.first, 0, lines.second, height);
//        canvas.drawRoundRect(rect, 30, 30, mRectPaint);
//        if(lines.first.floatValue() == 0f){
//            canvas.drawRect(lines.second - 1, 0/*height - mIndicatorHeight*/, lines.second, height, mRectPaint);
//        } else {
//            canvas.drawRect(lines.first , 0/*height - mIndicatorHeight*/, lines.first, height, mRectPaint);
//        }
//        System.err.println("--first---" + lines.first);
//        System.err.println("---second--" + lines.second);
//        //canvas.drawRect(0/*lines.first + mPaddingLeft*/, height - mIndicatorHeight, mTabsContainer.getWidth()/*lines.second + mPaddingLeft*/, height, mRectPaint);
////        }
//
////        super.onDraw(canvas);
////        if (isInEditMode() || mTabCount == 0) {
...
////                mRectPaint.setColor(MaterialColorPalette.getRandomColor(i));
////                //canvas.drawLine(tab.getLeft(), mDividerPadding, tab.getRight(), height - mDividerPadding, mDividerPaint);
////                canvas.drawRect(tab.getLeft() + mPaddingLeft, tab.getTop(), tab.getRight() + mPaddingLeft, height, mRectPaint);
////            }
////        }
////
////        // draw underline
...
////            mRectPaint.setAntiAlias(true);
////
////            mRectPaint.setMaskFilter(new BlurMaskFilter(4, BlurMaskFilter.Blur.SOLID));
////
////            mRectPaint.setStyle(Paint.Style.FILL_AND_STROKE);
////            mRectPaint.setColor(MaterialColorPalette.getRandomColor(positionColor));
////            //canvas.drawRect(lines.first + mPaddingLeft, 0/*height - mIndicatorHeight*/, lines.second + mPaddingLeft, height, mRectPaint);
////        }
//    }
//
...
//        if (tab != null) {
//            TextView tab_title = (TextView) tab.findViewById(R.id.tab_title_id);
//            if (tab_title != null) {
